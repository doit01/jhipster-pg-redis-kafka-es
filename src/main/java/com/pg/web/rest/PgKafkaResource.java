...
@RestController
@RequestMapping("/api/pg-kafka")
public class PgKafkaResource {

    private final Logger log = LoggerFactory.getLogger(PgKafkaResource.class);
    ...
    public PgKafkaResource(@Qualifier(KafkaSseProducer.CHANNELNAME) MessageChannel output) {
        this.output = output;
    }
